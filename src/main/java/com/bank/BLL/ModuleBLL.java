...
//    }
    ...
    public Pair<Boolean, String> exists(Module module) {
        List<Module> modules = searchModules("[name] = '" + module.getName() + "'");
    ...
    public Pair<Boolean, String> checkDecentralization(Module module) {
        ...
        List<Decentralization> decentralizationss = decentralizationBLL.searchDecentralizations("[module_id] = " + module.getId());
