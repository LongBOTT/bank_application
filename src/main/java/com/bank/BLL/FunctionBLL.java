...
import com.bank.DAL.FunctionDAL;
...
//    }
    ...
    public Pair<Boolean, String> exists(Function function) {
        List<Function> functions = searchFunctions("[name] = '" + function.getName() + "'");
    ...
    public Pair<Boolean, String> checkDecentralization(Function function) {
        ...
        List<Decentralization> decentralizationss = decentralizationBLL.searchDecentralizations("[function_id] = " + function.getId());
